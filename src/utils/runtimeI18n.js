...
const ES = new Map([
  ...
  ['Claimed By', 'Reclamado por'], ['Reclaimed By', 'Reclamado por'], ['Not claimed', 'No reclamado'],
  ['Created', 'Creado'], ['Reason', 'Motivo'], ['Priority', 'Prioridad'],
  ['Reopen Ticket', 'Reabrir Ticket'], ['Delete Ticket', 'Eliminar Ticket'],
  ['Ticket Pinned', 'Ticket Fijado'], ['Ticket Unpinned', 'Ticket No Fijado'],
  ['Your Ticket Has Been Closed', 'Tu Ticket Ha Sido Cerrado'], ['Your ticket', 'Tu ticket'],
  ['has been closed.', 'ha sido cerrado.'], ['Closed by:', 'Cerrado por:'], ['Closed at:', 'Cerrado el:'],
  ...
  ['Ticket Transcript', 'Transcripción del Ticket'], ['Transcript for ticket', 'Transcripción del ticket'],
  ['Ticket ID', 'ID del Ticket'], ['Channel', 'Canal'], ['Generated', 'Generado'], ['Deleted by:', 'Eliminado por:'],
  ['Timestamp (UTC)', 'Marca de tiempo (UTC)'], ['Author', 'Autor'], ['Message', 'Mensaje'], ['Transcript', 'Transcripción'],
  ['Not a Ticket Channel', 'No es un canal de Ticket'], ['Permission Denied', 'Permiso Denegado'],
  ['Request Timeout', 'Tiempo de espera agotado'], ['Rate Limited', 'Límite de solicitudes'], ['Ticket Limit Reached', 'Límite de Tickets Alcanzado'],
  ['You cannot close this ticket.', 'No puedes cerrar este ticket.'], ['You cannot claim tickets.', 'No puedes reclamar tickets.'],
  ['You cannot unclaim tickets.', 'No puedes liberar tickets.'], ['You cannot reopen tickets.', 'No puedes reabrir tickets.'],
  ['You cannot delete tickets.', 'No puedes eliminar tickets.'], ['You cannot pin tickets.', 'No puedes fijar tickets.'],
...
function toPlain(value, seen = new WeakSet()) {
  ...
  if (typeof value.toJSON === 'function') {
    try { return toPlain(value.toJSON(), seen); } catch {}
  }
...
patchMethod(CommandInteraction, 'showModal', fn => async function(modal, ...args) {
  return fn.call(this, await translatePayload(modal, this.client, this.guildId), ...args);
});
