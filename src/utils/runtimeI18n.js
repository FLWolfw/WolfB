...
const ES = new Map([
  ...
  ['Claim', 'Reclamar'], ['Claimed', 'Reclamado'], ['Unclaim', 'Liberar'], ['Pin', 'Fijar'],
  ['Low', 'Baja'], ['Medium', 'Media'], ['High', 'Alta'], ['Urgent', 'Urgente'], ['None', 'Ninguna'],
  ['Ticket Created', 'Ticket Creado'], ['Ticket Closed', 'Ticket Cerrado'], ['Ticket Reopened', 'Ticket Reabierto'],
  ['Ticket Deleted', 'Ticket Eliminado'], ['Ticket Claimed', 'Ticket Reclamado'], ['Ticket Unclaimed', 'Ticket Liberado'],
  ['Priority Updated', 'Prioridad Actualizada'], ['Status', 'Estado'], ['Open', 'Abierto'], ['Closed', 'Cerrado'],
  ['Claimed By', 'Reclamado por'], ['Reclaimed By', 'Reclamado por'], ['Not claimed', 'No reclamado'], ['Created', 'Creado'],
  ['Reason', 'Motivo'], ['Priority', 'Prioridad'], ['Reopen Ticket', 'Reabrir Ticket'], ['Delete Ticket', 'Eliminar Ticket'],
  ['Ticket Pinned', 'Ticket Fijado'], ['Ticket Unpinned', 'Ticket No Fijado'],
  ['Your ticket has been created in', 'Tu ticket ha sido creado en'],
  ['Your ticket', 'Tu ticket'], ['has been closed.', 'ha sido cerrado.'], ['Closed by:', 'Cerrado por:'], ['Closed at:', 'Cerrado el:'],
  ['has reopened this ticket!', '¡ha reabierto este ticket!'], ['has claimed this ticket!', '¡ha reclamado este ticket!'],
  ['has unclaimed this ticket!', '¡ha liberado este ticket!'], ['Thanks for creating a ticket!', '¡Gracias por crear un ticket!'],
  ...
  ['A priority value is required.', 'Se requiere un valor de prioridad.'], ['Ticket priority set to', 'Prioridad del ticket establecida en'],
  ...
  ['Current Tickets:', 'Tickets actuales:'], ['Failed to create ticket. Please try again in a moment.', 'No se pudo crear el ticket. Inténtalo de nuevo en un momento.'],
  ...
  ['Ticket Transcript', 'Transcripción del Ticket'], ['Transcript for ticket', 'Transcripción del ticket'], ['Ticket ID', 'ID del Ticket'],
  ['Channel', 'Canal'], ['Generated', 'Generado'], ['Deleted by:', 'Eliminado por:'], ['Timestamp (UTC)', 'Marca de tiempo (UTC)'],
  ['Author', 'Autor'], ['Message', 'Mensaje'], ['Transcript', 'Transcripción'], ['Not a Ticket Channel', 'No es un canal de Ticket'],
  ['Permission Denied', 'Permiso Denegado'], ['Request Timeout', 'Tiempo de espera agotado'], ['Rate Limited', 'Límite de solicitudes'],
  ['Ticket Limit Reached', 'Límite de Tickets Alcanzado'], ['You cannot close this ticket.', 'No puedes cerrar este ticket.'],
  ['You cannot claim tickets.', 'No puedes reclamar tickets.'], ['You cannot unclaim tickets.', 'No puedes liberar tickets.'],
  ['You cannot reopen tickets.', 'No puedes reabrir tickets.'], ['You cannot delete tickets.', 'No puedes eliminar tickets.'],
  ['You cannot pin tickets.', 'No puedes fijar tickets.'], ['You cannot change ticket priority.', 'No puedes cambiar la prioridad del ticket.'],
  ['The permission check took too long. Please try again.', 'La comprobación de permisos tardó demasiado.'],
  ['Failed to check permissions:', 'No se pudieron comprobar los permisos:'], ['This ticket is already claimed by', 'Este ticket ya ha sido reclamado por'],
  ['This ticket is not currently closed', 'Este ticket no está cerrado actualmente'], ['This ticket is not currently claimed', 'Este ticket no está reclamado actualmente'],
  ...
  ['Ticket operation failed:', 'La operación del ticket falló:'], ['Guild Only', 'Solo servidores'],
  ['This action can only be used in a server.', 'Esta acción solo se puede utilizar en un servidor.'], ['Support Tickets', 'Tickets de Soporte'],
  ['Open ticket', 'Abrir ticket'], ['Create Ticket', 'Crear Ticket'], ['Cancel', 'Cancelar'], ['Send', 'Enviar'],
]);
...
function translateText(value, language) {
  ...
  let result = value;
  // Always translate the longest phrases first. Otherwise a short entry such
  // as "Your ticket" can partially translate a longer phrase before its exact
  // translation is reached, producing mixed text like "Tu ticket has been created in".
